...
//    sectors[1].leftup[1] = 3.5;
    sectors[0].rightdown[0] = -2;
    sectors[0].rightdown[1] = -2;
    sectors[0].rightup[0] = -2;
    sectors[0].rightup[1] = 2;
    sectors[0].leftdown[0] = 2;
    sectors[0].leftdown[1] = -2;
    sectors[0].leftup[0] = 2;
    sectors[0].leftup[1] = 2;
